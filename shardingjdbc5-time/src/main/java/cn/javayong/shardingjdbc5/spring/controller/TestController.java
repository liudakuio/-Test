...
public class TestController {
    ...
    @GetMapping("/queryOrderOne")
    @ApiOperation("queryOrderOne")
    public ResponseEntity queryOrderOne(String orderId) {
        List<Map<String, Object>> orderMap = orderService.queryOrderOne(Long.valueOf(orderId));
        return ResponseEntity.successResult(orderMap);
    }
